...
export default function Footer() {
  return (
    <footer className="w-full bg-brand-bg border-t border-white/10 pt-20 pb-10 px-6 relative z-30">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        ...
        <div className="col-span-1 md:col-span-1">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="font-display font-bold text-xl text-white tracking-tight">TransitOps</span>
          </div>
          <p className="text-sm text-gray-500 max-w-xs">
            Run your fleet on autopilot. The complete platform for modern fleet operations and compliance.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li><a href="#" className="text-sm text-gray-400 hover:text-white transition-colors">Vehicle Registry</a></li>
            <li><a href="#" className="text-sm text-gray-400 hover:text-white transition-colors">Driver Management</a></li>
            <li><a href="#" className="text-sm text-gray-400 hover:text-white transition-colors">Trip Dispatch</a></li>
            <li><a href="#" className="text-sm text-gray-400 hover:text-white transition-colors">Maintenance</a></li>
          </ul>
        </div>
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between pt-8 border-t border-white/5">
