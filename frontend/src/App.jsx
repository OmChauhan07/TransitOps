      ...
      <Router>
        <Routes>
          ...
          <Route element={<Layout />}>
            ...
            <Route path="/fleet" element={<ProtectedRoute allowedRoles={['FLEET_MANAGER']}><div className="text-slate-100 p-8">Fleet Registry Placeholder</div></ProtectedRoute>} />
            <Route path="/drivers" element={<ProtectedRoute allowedRoles={['FLEET_MANAGER', 'SAFETY_OFFICER']}><div className="text-slate-100 p-8">Driver Profiles Placeholder</div></ProtectedRoute>} />
